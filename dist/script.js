...
const App = () => {
  const Splash = () =>
  React.createElement("svg", { viewBox: "0 0 100 125", onAnimationEnd: anim => endSplash(anim) },
  ...
  React.createElement("main", { onScroll: e => scrollHandler(e) },
  ...
  React.createElement("button", { className: "search", onClick: () => filterQuotes() })),
  ...
  filtered.map(({ text, delay }, index) => {
    ...
    return (
      React.createElement("article", { key: index, style: style },
      text));
  ...
  more && React.createElement("button", { className: "load", onClick: () => loadQuotes(5) }));


};
ReactDOM.render(React.createElement(App, null), document.querySelector("div"));